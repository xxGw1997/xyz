      ...
      <div className="relative z-10">
        <div className="mb-2 flex items-center justify-between">
          ...
          <div className="text-white/60 text-xs">
            {format(new Date(weatherAtLocation.current.time), "M月d日 HH:mm")}
          </div>
        </div>
        ...
        <div className="mt-2 flex justify-between text-white/60 text-xs">
          <div>
            日出：{format(new Date(weatherAtLocation.daily.sunrise[0]), "HH:mm")}
          </div>
          <div>
            日落：{format(new Date(weatherAtLocation.daily.sunset[0]), "HH:mm")}
          </div>
        </div>
      </div>
    </div>
