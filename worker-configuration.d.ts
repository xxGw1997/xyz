/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 390109ada44b102d600854249c300014)
// Runtime types generated with workerd@1.20260708.1 2025-12-25 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	GMICLOUD_APIKEY: string;
	TURN_ID: string;
	TURN_TOKEN: string;
	...
	AI_API_KEY: string;
	AI_MODEL: string;
	VEET: DurableObjectNamespace<import("./worker/index").Veet>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "Veet" | "ChatRoom" | "ChatAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GMICLOUD_APIKEY" | "TURN_ID" | "TURN_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "DATABASE_ID" | "VITE_BASE_URL" | "BETTER_AUTH_SECRET" | "RESEND_KEY" | "AI_BASE_URL" | "AI_API_KEY" | "AI_MODEL">> {}
}
